 ...
 * @endcode
 */
$settings['hash_salt'] = getenv('DRUPALSALT');
...
# }
$databases['default']['default'] = array (
  'database' => getenv('DRUPALDB'),
  'username' => getenv('DRUPALDBUSER'),
  'password' => getenv('DRUPALDBPASS'),
  'prefix' => '',
  'host' => getenv('DRUPALDBHOST'),
  'port' => '3306',
  'namespace' => 'Drupal\\Core\\Database\\Driver\\mysql',
  'driver' => 'mysql',
);
$settings['install_profile'] = 'standard';
$config_directories['sync'] = 'sites/default/files/config_9GtCgEx8ac-jYwGLWp87udLYAC39TEaWPzCiBnSIHzLA68wLUAjZHTTvF-FyGzD9zMsCGLCFsw/sync';
